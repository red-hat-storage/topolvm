...
parameters:
  # This field is for selecting the mode of restoring volume. It must be `local`
  # for snapshots intended to be created on the same node.
  "topolvm.cybozu.com/restore-mode": "local"
```
